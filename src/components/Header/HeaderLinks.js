  ...
  return (
    <List className={classes.list}>
      <ListItem className={classes.listItem}>
        ...
        >
          <Button
            href="https://twitter.com/verabradley?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"
            target="_blank"
            color="transparent"
      ...
      <ListItem className={classes.listItem}>
        ...
        >
          <Button
            color="transparent"
            href="https://www.instagram.com/verabradley/?hl=en"
            target="_blank"
            className={classes.navLink}
          >
      ...
      <ListItem className={classes.listItem}>
        ...
        >
          <Button
            color="transparent"
            href="https://www.youtube.com/c/verabradley/featured"
            target="_blank"
            className={classes.navLink}
          >
